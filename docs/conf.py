...
import os
import sys
sys.path.insert(0, os.path.abspath('../pandas_market_calendars'))
...
htmlhelp_basename = 'pandas_market_calendarsdoc'
...
latex_documents = [
    (master_doc, 'pandas_market_calendars.tex', 'pandas\\_market\\_calendars Documentation',
     'Ryan Sheftel', 'manual'),
]
