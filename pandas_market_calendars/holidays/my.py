...
ChineseNewYear1 = AbstractHolidayCalendar(rules=[
...
ChineseNewYear2 = AbstractHolidayCalendar(rules=[
...
Thaipusam = AbstractHolidayCalendar(rules=[
...
WesakDay = AbstractHolidayCalendar(rules=[
...
HariRayaPuasa1 = AbstractHolidayCalendar(rules=[
...
HariRayaPuasa2 = AbstractHolidayCalendar(rules=[
...
NuzulAlQuran = AbstractHolidayCalendar(rules=[
...
HariRayaHaji = AbstractHolidayCalendar(rules=[
...
MaalHijrah = AbstractHolidayCalendar(rules=[
...
MaulidNabi = AbstractHolidayCalendar(rules=[
...
Deepavali = AbstractHolidayCalendar(rules=[
