...
class NSEExchangeCalendar(MarketCalendar):
    """
    Exchange calendar for the National Stock Exchange (NSE).
    Open Time: 9:15 AM, Asia/Calcutta
    Close Time: 3:30 PM, Asia/Calcutta

    Due to the complexity around the NSE holidays, we are hardcoding a list
