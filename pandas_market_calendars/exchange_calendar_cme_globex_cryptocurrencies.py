...
class CMEGlobexCryptocurrenciesExchangeCalendar(CMEGlobexBaseExchangeCalendar):
    ...
    @property
    def name(self):
        return "CME Globex Cryptocurrencies"
    ...
    def special_closes(self):
        ...
        return [
            ...
            (
                ...
                AbstractHolidayCalendar(rules=[ChristmasEveInOrAfter1993]),
            ),
