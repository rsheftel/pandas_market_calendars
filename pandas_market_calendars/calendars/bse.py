...
BSEClosedDay = [
    ...
    Timestamp("2024-01-22", tz="UTC"),  # Mon, Ram Mandir Pran Pratishtha ceremony
    ...
    Timestamp("2024-11-20", tz="UTC"),  # Wed, Maharashtra Assembly Elections
    ...
    Timestamp("2026-01-15", tz="UTC"),  # Thu, Maharashtra Municipal Elections
