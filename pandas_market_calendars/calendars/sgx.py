...
from pandas.tseries.holiday import AbstractHolidayCalendar, GoodFriday, Holiday, weekend_to_monday, previous_friday
...
_SGNewYearsDay = Holiday("New Year's Day", month=1, day=1, observance=weekend_to_monday)

_SGNewYearsEve = Holiday("New Year's Eve", month=12, day=31, observance=previous_friday)

_SGLabourDay = Holiday("Labour Day", month=5, day=1, observance=weekend_to_monday)

_SGNationalDay = Holiday("National Day", month=8, day=9, observance=weekend_to_monday)

_SGChristmasDay = Holiday("Christmas Day", month=12, day=25, observance=weekend_to_monday)
...
_SGChineseNewYear2 = [
    ...
    Timestamp("2024-02-12"),  # Feb 11 Sun -> Mon Feb 12
