...
from pandas_market_calendars.exchange_calendars.cme_globex_fixed_income import CMEGlobexFixedIncomeCalendar
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('2009-04-09', '1515'), ('2009-04-10', 'closed'), ('2009-04-13', 'open'),

        # 2009 Memorial Day (May 25 = Monday)
        ('2009-05-22', '1515'), ('2009-05-25', '1200'), ('2009-05-26', 'open'),

        # 2009 Independence Day (4th = Saturday)
        ('2009-07-02', 'open'), ('2009-07-03', '1200'), ('2009-07-06', 'open'),

        # 2009 Labor Day (7th = Monday)
        ('2009-09-04', '1515'), ('2009-09-07', '1200'), ('2009-09-08', 'open'),

        # 2009 Thanksgiving (26th = Thursday)
        ('2009-11-25', 'open'), ('2009-11-26', '1200'), ('2009-11-27', '1215'), ('2009-11-30', 'open'),
        ...
        ('2010-09-03', '1515'), ('2010-09-06', '1200'), ('2010-09-07', 'open'),

        # 2010 Thanksgiving (25th = Thursday)
        ('2010-11-24', 'open'), ('2010-11-25', '1200'), ('2010-11-26', '1215'), ('2010-11-29', 'open'),

        # 2010 Christmas (25th = Saturday)
        ('2010-12-23', 'open'), ('2010-12-24', 'closed'), ('2010-12-27', 'open'),

        # 2010/11 New Year's (Dec 31 = Fri)
        ('2010-12-30', 'open'), ('2010-12-31', '1215'), ('2011-01-03', 'open'),
        ...
        ('2011-05-27', '1515'), ('2011-05-30', '1200'), ('2011-05-31', 'open'),

        # 2011 Independence Day (4th = Monday)
        ('2011-07-01', '1515'), ('2011-07-04', '1200'), ('2011-07-05', 'open'),

        # 2011 Labor Day (5th = Monday)
        ('2011-09-02', '1515'), ('2011-09-05', '1200'), ('2011-09-06', 'open'),
        ...
        ('2012-01-13', '1515'), ('2012-01-16', '1200'), ('2012-01-17', 'open'),

        # 2012 Presidents Day (20th = Monday)
        ('2012-02-17', '1515'), ('2012-02-20', '1200'), ('2012-02-21', 'open'),
        ...
        ('2012-08-31', '1515'), ('2012-09-03', '1200'), ('2012-09-04', 'open'),

        # 2012 Thanksgiving (22 = Thursday)
        ('2012-11-21', 'open'), ('2012-11-22', '1200'), ('2012-11-23', '1215'), ('2012-11-26', 'open'),

        # 2012 Christmas (25th = Friday)
        ('2012-12-24', '1215'), ('2012-12-25', 'closed'), ('2012-12-26', 'open'),  ## 5am on 26th

        # 2012/13 New Year's (Dec 31 = Monday)
        ('2012-12-31', 'open'), ('2013-01-01', 'closed'), ('2013-01-02', 'open'),  ## 5am on 2nd

        # 2013
        # 2013 Martin Luther King Day (21st = Monday)
        ('2013-01-18', '1515'), ('2013-01-21', '1200'), ('2013-01-22', 'open'),

        # 2013 Presidents Day (18th = Monday)
        ('2013-02-15', '1515'), ('2013-02-18', '1200'), ('2013-02-19', 'open'),

        # 2013 Good Friday (3/29 = Friday)
        ('2013-03-28', 'open'), ('2013-03-29', 'closed'), ('2013-04-01', 'open'),

        # 2013 Memorial Day (May 27 = Monday)
        ('2013-05-24', '1515'), ('2013-05-27', '1200'), ('2013-05-28', 'open'),

        # 2013 Independence Day (4th = Thursday)
        ('2013-07-03', 'open'), ('2013-07-04', '1200'), ('2013-07-05', 'open'),

        # 2013 Labor Day (2nd = Monday)
        ('2013-08-30', '1515'), ('2013-09-02', '1200'), ('2013-09-03', 'open'),

        # 2013 Thanksgiving (28th = Thursday)
        ('2013-11-27', 'open'), ('2013-11-28', '1200'), ('2013-11-29', '1215'), ('2013-04-02', 'open'),

        # 2013 Christmas (25th = Wednesday)
        ('2013-12-24', '1215'), ('2013-12-25', 'closed'), ('2013-12-26', 'open'),  ### 5am 26th

        # 2013/14 New Year's (Dec 31 = Tue)
        ('2013-12-31', 'open'), ('2014-01-01', 'closed'), ('2014-01-02', 'open'),  ### 5am 2nd


        # 2014
        # 2014 Martin Luther King Day (20th = Monday)
        ('2014-01-17', '1515'), ('2014-01-20', '1200'), ('2014-01-21', 'open'),

        # 2014 Presidents Day (17th = Monday)
        ('2014-02-14', '1515'), ('2014-02-17', '1200'), ('2014-02-18', 'open'),

        # 2014 Good Friday (18th = Friday)
        ('2014-04-17', 'open'), ('2014-04-18', 'closed'), ('2014-04-21', 'open'),

        # 2014 Memorial Day (May 26 = Monday)
        ('2014-05-23', '1515'), ('2014-05-26', '1200'), ('2014-05-27', 'open'),

        # 2014 Independence Day (4th = Friday)
        ('2014-07-02', 'open'), ('2014-07-03', 'open'), ('2014-07-04', '1200'), ('2014-07-07', 'open'),

        # 2014 Labor Day (1st = Monday)
        ('2014-08-29', '1515'), ('2014-09-01', '1200'), ('2014-09-02', 'open'),

        # 2014 Thanksgiving (27th = Thursday)
        ('2014-11-26', 'open'), ('2014-11-27', '1200'), ('2014-11-28', '1215'), ('2014-12-01', 'open'),
        ...
        ('2015-01-16', '1515'), ('2015-01-19', '1200'), ('2015-01-20', 'open'),

        # 2015 Presidents Day (16th = Monday)
        ('2015-02-13', '1515'), ('2015-02-16', '1200'), ('2015-02-17', 'open'),

        # 2015 Good Friday (03th = Friday)
        ('2015-04-02', 'open'), ('2015-04-03', '1015'), ('2015-04-06', 'open'),

        # 2015 Memorial Day (May 25 = Monday)
        ('2015-05-22', '1515'), ('2015-05-25', '1200'), ('2015-05-26', 'open'),

        # 2015 Independence Day (4th = Saturday)
        ('2015-07-02', 'open'), ('2015-07-03', '1200'), ('2015-07-06', 'open'),

        # 2015 Labor Day (7th = Monday)
        ('2015-09-04', 'open'), ('2015-09-07', '1200'), ('2015-09-08', 'open'),
        ...
        ('2016-07-01', 'open'), ('2016-07-04', '1200'), ('2016-07-05', 'open'),

        # 2016 Labor Day (5th = Monday)
        ('2016-09-02', 'open'), ('2016-09-05', '1200'), ('2016-09-06', 'open'),

        # 2016 Thanksgiving (24 = Thursday)
        ('2016-11-23', 'open'), ('2016-11-24', '1200'), ('2016-11-25', '1215'), ('2016-11-28', 'open'),
        ...
        ('2017-06-30', 'open'), ('2017-07-03', 'open'), ('2017-07-04', '1200'), ('2017-07-05', 'open'),

        # 2017 Labor Day (4th = Monday)
        ('2017-09-01', 'open'), ('2017-09-04', '1200'), ('2017-09-05', 'open'),

        # 2017 Thanksgiving (23 = Thursday)
        ('2017-11-22', 'open'), ('2017-11-23', '1200'), ('2017-11-24', '1215'), ('2017-11-27', 'open'),
        ...
        ('2018-07-02', 'open'), ('2018-07-03', 'open'), ('2018-07-04', '1200'), ('2018-07-05', 'open'),

        # 2018 Labor Day (3rd = Monday)
        ('2018-08-31', 'open'), ('2018-09-03', '1200'), ('2018-09-04', 'open'),

        # 2018 Thanksgiving (22nd = Thursday)
        ('2018-11-21', 'open'), ('2018-11-22', '1200'), ('2018-11-23', '1215'), ('2018-11-26', 'open'),
        ...
        ('2019-07-02', 'open'), ('2019-07-03', 'open'), ('2019-07-04', '1200'), ('2019-07-05', 'open'),

        # 2019 Labor Day (2nd = Monday)
        ('2019-08-30', 'open'), ('2019-09-02', '1200'), ('2019-09-03', 'open'),

        # 2019 Thanksgiving (28 = Thursday)
        ('2019-11-27', 'open'), ('2019-11-28', '1200'), ('2019-11-29', '1215'), ('2019-12-02', 'open'),
        ...
        ('2021-12-31', 'open'), ('2022-01-03', 'open'), ('2022-01-04', 'open'),

        # 2022
        # 2022 Martin Luther King Day (17th = Monday)
        ('2022-01-14', 'open'), ('2022-01-17', '1200'), ('2022-01-18', 'open'),

        # 2022 President's Day (21st = Monday)
        ('2022-02-18', 'open'), ('2022-02-21', '1200'), ('2022-02-22', 'open'),
        ...
        ('2022-09-02', 'open'), ('2022-09-05', '1200'), ('2022-09-06', 'open'),

        # 2022 Thanksgiving (24th = Thursday)
        ('2022-11-23', 'open'), ('2022-11-24', '1200'), ('2022-11-25', '1215'), ('2022-11-28', 'open'),
